...
public record UpdateTaskRequestDto(
    ...
    private final static String ERROR_MESSAGE_DESCRIPTION_LENGTH =
            "Description must be less than 1000 characters";

    private final static String ERROR_MESSAGE_DUE_DATE_FUTURE =
            "Due date must be in the future";

    private final static String ERROR_MESSAGE_PRIORITY =
            "Task priority must be provided";

    private final static String ERROR_MESSAGE_STATUS =
